...
#   NYT_API_KEY=... IMAGE=ghcr.io/h11t-labs/online-bibliotheek-catalogus:0.2 ./railway-setup.sh
set -euo pipefail
...
✓ Done. Next:
  ...
  2. Wire CI auto-deploy:
       gh variable set RAILWAY_SERVICE --repo h11t-labs/online-bibliotheek-catalogus --body "$SERVICE"
       gh secret   set RAILWAY_TOKEN   --repo h11t-labs/online-bibliotheek-catalogus   # paste a Railway token
EOF
